            ...
            <div class="row justify-content-center">
                ...
                <div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                    <div class="rounded shadow py-5 px-4">
                        ...
                        <p class="mb-4">{{ Str::limit($service->short_desc, 100)}}</p> <a class="btn btn-sm btn-outline-primary" wire:navigate href="{{route('serviceDetils',$service->id)}}">View Details <i class="las la-arrow-right ms-1"></i></a>
