                ...
                @foreach ($teams as $team)
                    <div class="col-xl-3 col-lg-4 col-md-6 mt-4">
                        <div class="card bg-transparent border-0 text-center">
                            <div class="card-img">
                                <img loading="lazy" decoding="async" src="{{ $team->images }}" alt="Scarlet Pena"
                                    class="rounded w-100" width="300" height="332">
                                @if ($team->fb_url != '' || $team->tw_url != '' || $team->linkin_url != '')
                                    <ul class="card-social list-inline">
                                        @if ($team->fb_url != '')
                                            <li class="list-inline-item"><a target="_blank" class="facebook"
                                                    href="{{ $team->fb_url }}"><i class="fab fa-facebook"></i></a>
                                            </li>
                                        @endif
                                        @if ($team->tw_url != '')
                                            <li class="list-inline-item"><a class="twitter" target="_blank"
                                                    href="{{ $team->tw_url }}"><i class="fab fa-twitter"></i></a>
                                            </li>
                                        @endif
                                        @if ($team->linkin_url != '')
                                            <li class="list-inline-item"><a class="instagram" target="_blank"
                                                    href="{{ $team->linkin_url }}"><i class="fab fa-instagram"></i></a>
                                            </li>
                                        @endif
